...
export class ChainContainer {
   ...
   * 
   * @param value - the value to use along the chain
   */
   ...
   * ```
   * 
   * @param {MappableFn} fn - function that can either return a value or array of values.
   * @returns {ChainContainer}
   ...
   * @returns {ChainContainer}
   */
  replace(value:any):ChainContainer {
    this.value = value;
    return this;
  }
 ...
 * @module chain
 */
export default function chain(value:any):ChainContainer {
